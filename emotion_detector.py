...
#if we have to detect multiple things then we will use multiple AI brains....
...
while True:
    ...
    roi_gray = gray[y:y+h, x:x+w]  #region of interest(particular face from the whole image)qq
